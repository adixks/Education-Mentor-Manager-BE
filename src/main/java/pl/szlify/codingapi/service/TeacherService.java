...
public class TeacherService {
    ...
    public Page<TeacherShortListDto> getList(Pageable pageable) {
        return teacherRepository.findAll(pageable).map(teacherMapper::toShortListDto);
    }
